...
# Notion API setup
NOTION_API_KEY = "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"  # Replace with your Notion API Key
DATABASE_ID = "17cebcf981cf804a8e19e36a624d4dc4"  # Replace with your Notion Database ID
...
print("Data sync from Notion to SQL completed successfully!")
